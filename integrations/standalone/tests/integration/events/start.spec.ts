...
import { fillReloadAndAssert, NameTabTest, NameTabTestWithoutTags, CaseTabTest, OutputTabTest } from '../tabs';
...
test.describe('Start Events', () => {
  ...
  test('WS Start', async ({ page }) => {
    ...
    await fillReloadAndAssert(page, [NameTabTest, CaseTabTest]);
  });
