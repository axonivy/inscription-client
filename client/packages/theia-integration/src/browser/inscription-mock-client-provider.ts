import { InscriptionClient, InscriptionClientMock } from "@axonivy/inscription-core";
import { Deferred } from "@theia/core/lib/common/promise-util";
import { injectable } from "@theia/core/shared/inversify";
import { InscriptionClientProvider } from "./inscription-client-provider";

@injectable()
export class MockInscriptionClientProvider implements InscriptionClientProvider {
    ...
    protected async createClient(client: Deferred<InscriptionClient>): Promise<void> {
        try {
            const webSocketClient = new InscriptionClientMock();
