import type { CodeEditorProps, EditorOptions, ResizableCodeEditorProps } from '@axonivy/monaco';
...
export type CodeEditorInputProps = Omit<CodeEditorProps, 'language' | 'options' | 'height' | 'onMountFuncs' | 'contextPath'> &
